                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" name="long_descrip" id="long_descrip" class="form-control" placeholder="Long description">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="short_descrip" id="short_descrip" class="form-control" placeholder="Short description">
                        </div>
                    </div>
                </div>
                <div class="row">
